  ...
  data() {
    return {
      ...
      pastTests: [
        ...
        { name: "Chemistry", icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 3h15"/><path d="M6 3v13a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4V3"/><path d="M6 14h12"/></svg>`, slug: "chemistry", file: "/files/chemistry.pdf" },
      ...
      specialTests: [
        ...
        { name: "Chemistry Special", icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 3h15"/><path d="M6 3v13a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4V3"/><path d="M6 14h12"/></svg>`, slug: "chemistryspecial", file: "/files/chemistry_exam.pdf" },
      ],
