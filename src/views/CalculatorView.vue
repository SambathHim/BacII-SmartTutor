...
export default {
  ...
  return {
    ...
    result: '',
      ...
      { key: 'physics', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 21h2"/><path d="M12 17v4"/><path d="M14 4A22 22 0 0 0 3 15"/><path d="M17 14A22 22 0 0 0 6 3"/><circle cx="12" cy="12" r="3"/><path d="m14.2 14.2 4.3 4.3"/></svg>`, score: null, maxScore: 75 },
      { key: 'chemistry', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 3h15"/><path d="M6 3v13a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4V3"/><path d="M6 14h12"/></svg>`, score: null, maxScore: 75 },
      { key: 'biology', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 10.5C7.8 13.8 13.2 13.8 16.5 10.5c.3-.3.3-.8 0-1.1-.3-.3-.8-.3-1.1 0-2.7 2.7-7.1 2.7-9.8 0-.3-.3-.8-.3-1.1 0-.3.3-.3.8 0 1.1z"/><path d="M19.5 13.5c-3.3-3.3-8.7-3.3-12 0-.3.3-.3.8 0 1.1.3.3.8.3 1.1 0 2.7-2.7 7.1-2.7 9.8 0 .3.3.8.3 1.1 0 .3-.3-.3-.8 0-1.1z"/><path d="m3.5 3.5 17 17"/></svg>`, score: null, maxScore: 75 },
      { key: 'khmerLiterature', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2-2.5z"/><path d="M6 6h10"/><path d="M6 10h10"/><path d="M6 14h10"/></svg>`, score: null, maxScore: 75 },
      { key: 'english', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>`, score: null, maxScore: 50, half: true },
    ],
    scienceSelection: [{ key: 'history', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>`, score: null, maxScore: 50 }],
    socialMain: [
      { key: 'khmerLanguage', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>`, score: null, maxScore: 125 },
      ...
      { key: 'history', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V8l-6-6z"/><path d="M14 3v5h5"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>`, score: null, maxScore: 75 },
      { key: 'moralCivics', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="2" x2="12" y2="22"/><line x1="5" y1="7" x2="19" y2="7"/><path d="M19 7c0 5-3.5 8-7 8s-7-3-7-8"/></svg>`, score: null, maxScore: 75 },
      { key: 'geography', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/><line x1="9" y1="3" x2="9" y2="18"/><line x1="15" y1="6" x2="15" y2="21"/></svg>`, score: null, maxScore: 75 },
      { key: 'foreignLanguage', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>`, score: null, maxScore: 50, half: true },
    ],
    socialSelection: [{ key: 'earthScience', icon: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>`, score: null, maxScore: 50 }],
  }
},
  computed: {
    mainSubjects() {
